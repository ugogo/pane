...
- Use generated components from `src/components/ui/*` before creating local primitives.
- Keep `src/styles.css` close to the shadcn default theme. Do not reintroduce Pane-specific design tokens, premium shell styling, or app-wide custom palettes without explicit design direction.
