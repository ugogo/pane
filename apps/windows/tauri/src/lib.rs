...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::light_presets::get_light_presets,
            commands::light_presets::save_light_preset,
            commands::light_presets::delete_light_preset,
            commands::light_presets::apply_light_preset,
